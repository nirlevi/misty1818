...
export const Chat: FC<Props> = ({ messages, loading, onSend, onReset }) => {
  return (
    <>
      ...
      <ul className="px-2 sm:p-4 sm:border border-neutral-300">- Misty1818 is an innovative AI Tool to explore the mystical realms of numerology, tarot cards, and astrology. Misty1818 AI Tool is a warm and inviting platform that combines the ancient arts of numerology, tarot, and astrology with modern technology.
